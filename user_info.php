...
$s .='      </select>';
$s .='      </br>';
$s .='       <label for="uban">Ban/Unban this User</label>';
$s .='     <select name="uban">';
$s .=sprintf('<option value="%s" selected>No action</option>', $row['TrangThaiNguoiDung']);
$s .='        <option value=0>Banned</option>';
$s .='        <option value=1>Unbanned</option>';
$s .='      </select>';
$s .='      </br>';
