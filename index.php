			...
			<div class="row">
						...
						<div class="col-md-6">
							<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
								...
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="#">ĐỒNG HỒ NAM</a></h2>
								</div>
							</div>
							<div class="category-wrap ftco-animate img d-flex align-items-end"
								style="background-image: url(images/bg_watch2.jpg);">
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="#">ĐỒNG HỒ CƠ</a></h2>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
						...
						<div class="text px-3 py-1">
							<h2 class="mb-0"><a href="#">ĐỒNG HỒ NỮ</a></h2>
						</div>
					</div>
					<div class="category-wrap ftco-animate img d-flex align-items-end"
						style="background-image: url(images/bg_watch4.jpg);">
						<div class="text px-3 py-1">
							<h2 class="mb-0"><a href="#">ĐỒNG HỒ PIN</a></h2>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span class="price">$20000.00</span></p>
								</div>
							</div>
